/*
  ...
  - You are about to drop the column `numero` on the `Pedido_de_compra` table. All the data in the column will be lost.
...
INSERT INTO "new_Pedido_de_compra" ("CEP", "data", "desconto", "endereco", "pedido_de_compra_id", "total_a_pagar", "usuario_id") SELECT "CEP", "data", "desconto", "endereco", "pedido_de_compra_id", "total_a_pagar", "usuario_id" FROM "Pedido_de_compra";
